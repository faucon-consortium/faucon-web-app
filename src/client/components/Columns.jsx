...
class ColumnsTest extends React.Component {
  constructor(props) {
    super(props);
    this.actions = [
      {
    ...
    this.filterData = (checked, name) => {
      ...
      if (checked) {
        ...
        const filteredColumns = this.defaultColumns.filter(
          (column) => !updatedFilters.includes(column)
        );
        const filteredRows = this.defaultRows.map(({ ...row }) => {
          row.cells = row.cells.filter(
            (cell) => !updatedFilters.includes(cell.props.column)
          );
          return row;
        });
        this.setState({
        ...
        const filteredColumns = columns.filter(
          (column) => !filters.includes(column)
        );
        const filteredRows = rows.map(({ ...row }) => {
          row.cells = row.cells.filter(
            (cell) => !filters.includes(cell.props.column)
          );
          return row;
        });
        this.setState({
          ...
          <DataListItem aria-labelledby="table-column-management-item2">
            <DataListItemRow>
              ...
              <DataListItemCells
                dataListCells={[
                  <DataListCell
                    id="table-column-management-item2"
                    key="table-column-management-item2"
                  >
                    Branches
                  </DataListCell>,
                ]}
          ...
          <DataListItem aria-labelledby="table-column-management-item3">
            <DataListItemRow>
              ...
              <DataListItemCells
                dataListCells={[
                  <DataListCell
                    id="table-column-management-item3"
                    key="table-column-management-item3"
                  >
                    Pull requests
                  </DataListCell>,
                ]}
          ...
          <DataListItem aria-labelledby="table-column-management-item4">
            <DataListItemRow>
              ...
              <DataListItemCells
                dataListCells={[
                  <DataListCell
                    id="table-column-management-item4"
                    key="table-column-management-item4"
                  >
                    Workspaces
                  </DataListCell>,
                ]}
          ...
          <DataListItem aria-labelledby="table-column-management-item5">
            <DataListItemRow>
              ...
              <DataListItemCells
                dataListCells={[
                  <DataListCell
                    id="table-column-management-item5"
                    key="table-column-management-item5"
                  >
                    Last commit
                  </DataListCell>,
                ]}
  ...
  render() {
    ...
    const toolbarItems = (
      <React.Fragment>
        <span
          id="page-layout-table-column-management-action-toolbar-top-select-checkbox-label"
          hidden
        >
          Choose one
        </span>
